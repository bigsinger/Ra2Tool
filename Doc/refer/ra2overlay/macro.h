...
#ifdef _MSC_VER
#define __RA2OVERLAY_BEGIN_THIRD_PARTY_HEADERS \
    _Pragma("warning(push, 0)") \
    _Pragma("warning(disable:4100)") \
    _Pragma("warning(disable:4324)") \
    _Pragma("warning(disable:4996)")
#define __RA2OVERLAY_END_THIRD_PARTY_HEADERS _Pragma("warning(pop)")
#else
#define __RA2OVERLAY_BEGIN_THIRD_PARTY_HEADERS
#define __RA2OVERLAY_END_THIRD_PARTY_HEADERS
#endif

#ifdef RA2OVERLAY_ENABLE_SIMD
#define CONST_GLM const
#else
#define CONST_GLM constexpr
#endif
